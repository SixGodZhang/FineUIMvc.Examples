...
{
    public class SummaryCurrentPageController : FineUIMvc.Examples.Controllers.BaseController
    {
        ...
        private void LoadData()
        {
            ...
            // 2.获取当前分页数据
            var pagedDataTable = DataSourceUtil.GetPagedDataTable(pageIndex: 0, pageSize: 5, recordCount: recordCount);
