...
{
    public class SortingPagingDatabaseCustomController : FineUIMvc.Examples.Controllers.BaseController
    {
        ...
        public ActionResult Grid1_PageIndexChangedOrSort(string[] fields, int pageIndex, string sortField, string sortDirection)
        {
            ...
            // 2.获取当前分页数据
            var dataSource = DataSourceUtil.GetPagedDataTable(pageIndex: pageIndex, pageSize: 5, recordCount: recordCount, sortField: sortField, sortDirection: sortDirection);
