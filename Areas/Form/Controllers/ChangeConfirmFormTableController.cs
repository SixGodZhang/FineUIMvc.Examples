...
{
    public class ChangeConfirmFormTableController : FineUIMvc.Examples.Controllers.BaseController
    {
        ...
        public ActionResult btnClosePostBack_Click(FormCollection values, string[] Grid1_fields, JArray Grid1_modifiedData)
        {
