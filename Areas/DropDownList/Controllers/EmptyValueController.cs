...
{
    public class EmptyValueController : FineUIMvc.Examples.Controllers.BaseController
    {
        // GET: DropDownList/EmptyValue
        ...
        {
            UIHelper.DropDownList("DropDownList1").SelectedValue("");
